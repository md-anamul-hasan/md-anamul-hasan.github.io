<template>
  <a :href="href" class="block text-teal-600">
    <!-- The logo SVG -->
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
      :class="`w-${size} h-${size} fill-teal-600 dark:fill-teal-300 hover:fill-gray-600 hover:dark:fill-gray-300`"
    >
      <!-- The logo path -->
      <g>
        <polygon
