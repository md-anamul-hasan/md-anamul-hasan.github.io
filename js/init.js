...
jQuery(document).ready(function() {
    "use strict";
    initFunctions();
    jQuery(window).on('scroll', dizme_tm_progress_line);
    jQuery(window).on('load', dizme_tm_my_load);
});

// Function to initialize all required functions
...
function dizme_tm_nav_bg() {
    ...
    jQuery(window).on('scroll', function() {
        ...
        menu.toggleClass('animate', WinOffset >= 100);
        progress.toggleClass('animate', WinOffset >= 100);
    });
}
...
function dizme_tm_service_popup() {
    ...
    button.on('click', function() {
        ...
        modalBox.find('.service_popup_informations')
            .prepend('<div class="image"><img src="img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="' + elImage + '"></div></div>')
...
function dizme_tm_modalbox_portfolio() {
    ...
    button.on('click', function() {
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(content);
        modalBox.find('.popup_details')
            .prepend('<div class="top_image"><img src="img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="' + image + '"></div></div>')
            .after('<div class="portfolio_main_title"><h3>' + title + '</h3><span><a href="#">' + category + '</a></span><div>');
...
function dizme_tm_projects() {
    ...
    jQuery('.dizme_tm_portfolio_animation_wrap').each(function() {
        jQuery(this).on('mouseenter', function() {
            var titleContainer = jQuery('.dizme_tm_portfolio_titles');
            if (jQuery(this).data('title')) {
                titleContainer.html(jQuery(this).data('title') + '<span class="work__cat">' + jQuery(this).data('category') + '</span>');
                titleContainer.addClass('visible');
            }

            jQuery(document).on('mousemove', function(e) {
                titleContainer.css({ left: e.clientX - 10, top: e.clientY + 25 });
            });
...
function progress_by_frenify(wrapper) {
    "use strict";
    var element = wrapper ? wrapper.find('.dodo_progress') : jQuery('.dodo_progress');
...
function dizme_tm_my_load() {
    "use strict";
    setTimeout(dizme_tm_preloader, 500);
}
...
function dizme_tm_owl_carousel() {
    ...
    var rtlMode = jQuery('body').hasClass('rtl');
...
// Input padding adjustment for subscribe form
...
function dizme_tm_down() {
    ...
    jQuery('.anchor').on('click', function() {
        if ($.attr(this, 'href') !== '#') {
            $('html, body').animate({ scrollTop: $($.attr(this, 'href')).offset().top - topbar - 175 }, 800);
        }
        return false;
    });
}

// Initialize WOW.js library for animations
new WOW().init();

// Wait for images and initialize Masonry Grid
